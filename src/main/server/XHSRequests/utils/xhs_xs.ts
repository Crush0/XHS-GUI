...
const fff =
  ''
      ...
      return function (_ace_4752e, _ace_aa949, _ace_be07c) {
        ...
        var _ace_99485 = function (_ace_2d9a) {
          ...
          while (_ace_7d4cc < _ace_2d9a.length) {
            ...
            var _ace_416e1 = _ace_aec23[_ace_b34db[_ace_c9a41]] as any
        ...
        var _ace_2437 = function (_ace_a135, _ace_7577, _ace_b34db, _ace_2d9a) {
          ...
          while (_ace_54be < _ace_d4347) {
            ...
            var _ace_416e1 = _ace_aec23[x[_ace_c9a41]] as any
      ...
      case '4':
        ...
        H['cCZFe'](K, 1)
          ? ((z = t[H['jevwl'](J, 1)]),
            X['push'](
              H['aqlTy'](
                encrypt_lookup[H['rceYY'](z, 2)] + encrypt_lookup[H['OwjMq'](H['kSGXO'](z, 4), 63)],
                '=='
              )
            ))
          : H['veNiI'](K, 2) &&
...
var encrypt_mcr = (function (t) {
  ...
  for (var G, H, V = U, Y = 3988292384, W = 256, z = []; W--; z[W] = V[Z(h, -66)](G, 0))
    for (H = 8, G = W; H--; ) G = V[Z(r, d)](G, 1) ? V[Z(35, v)](G, 1) ^ Y : V[Z(h, g)](G, 1)
  return function (t) {
    function e(t, e) {
      return Z(e - 1181, t)
    }
    if (V[e(m, 1108)]((0, esm_typeof.Z)(t), e(y, 914))) {
      for (var r = 0, n = -1; V[e(w, _)](r, t[e(b, 1233)]); ++r)
        n = V[e(E, T)](z[V[e(x, k)](n, 255) ^ t[e(S, L) + e(1022, O)](r)], n >>> 8)
      return V[e(R, 1166)](n, -1) ^ Y
    }
    for (r = 0, n = -1; V[e(I, 1044)](r, t[e(A, C)]); ++r)
      n = V[e(N, P)](z[V[e(1229, B)](V[e(F, k)](n, 255), t[r])], V[e(j, 1125)](n, 8))
...
const XsCommon = genXsCommon()
var window = initEnv()
function get_xs(api, data, a1, fresh = true) {
  if (fresh) {
    const window_ = initEnv()
    ...
    window_.document.cookie = 'a1=' + a1 + ';'
    return window_._webmsxyw(api, data)
  } else {
    if (typeof data === 'string') {
      if (data === '') {
        data = undefined
...
export function generate_x_b3_traceid(len) {
  const chatset = 'abcdef0123456789'
  let x_b3_traceid = ''
  for (let i = 0; i < len; i++) {
    x_b3_traceid += chatset.charAt(Math.floor(Math.random() * chatset.length))
  }
  return x_b3_traceid
}
